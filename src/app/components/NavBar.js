    ...
    <div className="relative flex items-center justify-between h-16">
      ...
      <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        <div className="text-gray-300 hover:bg-gray-700 hover:text-white">
            <img className="h-8 w-8 rounded-full color-white" src="/img/shopping-cart.svg"/>
            <div className="absolute top-2 right-11 text-xs   text-white bg-red-500 p-1 rounded-full">{inCartCount > 0 ? inCartCount : "" }</div></div>
